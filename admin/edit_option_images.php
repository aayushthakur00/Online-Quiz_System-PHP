                        ...
                        <form name="form1" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="form-group"><img src="<?php echo $opt1 ?>" height="50" width="50"><br><label for="company" class=" form-control-label">Add Opt1</label><input type="file" name="fopt1"  class="form-control" style="padding-bottom:35px"></div>
                                    <div class="form-group"><img src="<?php echo $opt2 ?>" height="50" width="50"><br><label for="company" class=" form-control-label">Add Opt2</label><input type="file" name="fopt2"  class="form-control" style="padding-bottom:35px"></div>
                                    <div class="form-group"><img src="<?php echo $opt3 ?>" height="50" width="50"><br><label for="company" class=" form-control-label">Add Opt3</label><input type="file" name="fopt3"  class="form-control" style="padding-bottom:35px" ></div>
                                    <div class="form-group"><img src="<?php echo $opt4 ?>" height="50" width="50"><br><label for="company" class=" form-control-label">Add Opt4</label><input type="file" name="fopt4"  class="form-control" style="padding-bottom:35px"></div>
                                    <div class="form-group"><img src="<?php echo $answer ?>" height="50" width="50"><br><label for="company" class=" form-control-label">Add Answer</label><input type="file" name="fanswer" class="form-control" style="padding-bottom:35px"></div>
