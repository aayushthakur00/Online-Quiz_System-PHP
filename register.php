...
<body>
                    ...
                    <div class="panel-body">
                        <form action="" name="form1" method="post">
                            ...
                            <div class="text-center">
                                <button type="submit" name="submit1" class="btn btn-success loginbtn" value="redirect">Register</button>
  ...
  <strong>Success!</strong> Account Registration Successful!
                            ...
                            <div class="alert alert-danger" id="failure" style="margin-bottom:10px">
